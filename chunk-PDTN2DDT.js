...
`)}function qS(r,e){let t;switch(e){case ug:t="Linear";break;case fg:t="Reinhard";break;case dg:t="Cineon";break;case pg:t="ACESFilmic";break;case gg:t="AgX";break;case _g:t="Neutral";break;case mg:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var dh=new Y;function YS(){at.getLuminanceCoefficients(dh);let r=dh.x.toFixed(4),e=dh.y.toFixed(4),t=dh.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
